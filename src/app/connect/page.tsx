...
export default function ConnectPage() {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      ...
      // Fetch user profile for city-based recommendations
      if (data?.user) {
        ...
        <div className="fixed inset-0 z-[200] bg-slate-900/40 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="w-full max-w-lg bg-white border border-slate-100 rounded-3xl p-8 flex flex-col gap-6 shadow-2xl">
            ...
            <div className="flex gap-4 mt-2">
              ...
              <button onClick={handleCreateCommunity} className="flex-1 py-4 bg-teal-600 hover:bg-teal-500 text-white rounded-full font-bold text-lg transition-colors shadow-md shadow-teal-500/20">
                Create
              </button>
            </div>
          </div>
