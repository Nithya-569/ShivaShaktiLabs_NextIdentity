...
import { Home, Users, Briefcase, Heart, LogIn, LogOut, X } from "lucide-react";
              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-2 px-5 py-2.5 rounded-full font-semibold text-sm transition-all ${
                    isActive ? "bg-teal-50 text-teal-700 shadow-sm" : "text-slate-600 hover:bg-slate-100"
                  }`}
                >
        ...
        {showAuth && !user && (
          <div className="fixed inset-0 z-[200] bg-slate-900/40 backdrop-blur-sm flex items-center justify-center p-4">
            <div className="w-full max-w-sm bg-white border border-slate-100 rounded-3xl p-8 flex flex-col gap-6 shadow-2xl relative">
              ...
              <h3 className="text-slate-800 text-2xl font-black tracking-tight text-center">Welcome 💛</h3>
