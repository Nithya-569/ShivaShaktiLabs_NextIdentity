      ...
      <div className="w-full max-w-4xl mx-auto flex flex-col gap-8 px-6 md:px-12 pt-8 md:pt-16">
        ...
        <div className="flex bg-white/60 p-2 rounded-2xl border border-white/40 shadow-sm overflow-x-auto gap-2">
          <button
            ...
            className={`flex-1 min-w-[120px] flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl font-bold transition-all ${activeTab === "jobs"
          ...
          <button
            ...
            className={`flex-1 min-w-[120px] flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl font-bold transition-all ${activeTab === "mentors"
                ? "bg-teal-700 text-white shadow-md"
                : "text-slate-600 hover:bg-white/60"
              }`}
          >
